<%@ Page Language="C#" AutoEventWireup="true" CodeFile="faculty_grades.aspx.cs" Inherits="faculty_grades" %>
...
">
        ...
        <asp:Button ID="Button1" class="btn" runat="server" OnClick="Button1_Click" Text="Button" />
            </div>
    </form>
</body>
</html>
